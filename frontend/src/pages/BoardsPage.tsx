...
// // import { mockBoards, mockEpics } from '@/lib/mock-data';
// // import { Layers, ChevronRight, MoreHorizontal, Calendar } from 'lucide-react';
...
// //   return (
// //     <DashboardLayout>
// //       <Topbar title="Boards" subtitle={`${mockBoards.length} projects`} createLabel="New Board" onCreateClick={() => {}} />
// //       <div className="flex-1 overflow-y-auto p-4">
// //         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
// //           {mockBoards.map((board) => {
// //             const epicCount = mockEpics.filter((e) => e.boardId === board.id).length;
// //             return (
// //               <button
// //                 key={board.id}
// //                 onClick={() => navigate(`/board/${board.id}`)}
// //                 className="text-left p-4 rounded-lg bg-card border border-border hover:border-primary/30 transition-all group"
// //               >
// //                 <div className="flex items-start justify-between mb-3">
// //                   <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
// //                     <Layers className="w-4 h-4 text-primary" />
// //                   </div>
// //                   <button className="p-1 rounded opacity-0 group-hover:opacity-100 hover:bg-muted transition-all text-muted-foreground">
// //                     <MoreHorizontal className="w-4 h-4" />
// //                   </button>
// //                 </div>
// //                 <h3 className="text-sm font-semibold text-foreground mb-1">{board.title}</h3>
...
//       try {
//         // Fetching real data from your Node.js backend
...
//               <Skeleton key={i} className="h-48 w-full rounded-xl bg-slate-900" />
//             ))}
//           </div>
//         ) : (
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
...
//               <Card
//                 key={board.id}
//                 className="group relative bg-slate-900 border-slate-800 hover:border-blue-500/50 transition-all duration-300 cursor-pointer overflow-hidden"
//                 onClick={() => navigate(`/board/${board.id}`)}
//               >
...
//                   </CardDescription>
//                   <div className="mt-6 flex items-center text-xs text-slate-500 gap-4">
//                     <div className="flex items-center gap-1">
//                       <Clock className="w-3 h-3" />
//                       <span>Updated {new Date(board.updatedAt || board.createdAt).toLocaleDateString()}</span>
//                     </div>
//                   </div>
//                 </CardHeader>
//               </Card>
