...
// //   { title: 'My Tasks', url: '/my-tasks', icon: FolderKanban },
// //   { title: 'Activity', url: '/activity', icon: Zap },
...
// //           </div>
// //           {!collapsed && (
// //             <span className="font-semibold text-sm text-foreground truncate">TaskBoard</span>
// //           )}
// //         </div>
// //       </div>
...
// //             end={item.url === '/'}
// //             className={cn(
// //               'flex items-center gap-2.5 px-2.5 py-1.5 rounded-md text-sm text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors',
...
// //           className="w-full flex items-center justify-center p-1.5 rounded-md text-muted-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors"
// //         >
...
// import { Layout, CheckSquare, Clock, LogOut, Settings } from 'lucide-react';
// import { cn } from '@/lib/utils';
...
//         </div>
//         <span className="font-black text-xl text-white tracking-tighter uppercase">TaskSync</span>
//       </div>
...
//               "w-4 h-4",
//               location.pathname === item.href ? "text-blue-400" : "text-slate-600"
//             )} />
//             {item.label}
//           </Link>
//         ))}
...
//               <AvatarFallback className="bg-blue-600 text-white font-bold">{user?.name?.charAt(0) || null}</AvatarFallback>
//             </Avatar>
//             <div className="flex-1 min-w-0">
//               <p className="text-sm font-black text-white truncate">{user?.name}</p>
//               <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest truncate">{user?.role?.[0]}</p>
//             </div>
//           </div>

//           <div className="grid grid-cols-2 gap-2">
//             <button className="flex items-center justify-center p-2 rounded-lg bg-slate-800 text-slate-400 hover:text-white transition-colors">
//               <Settings className="w-4 h-4" />
//             </button>
//             <button 
//               onClick={handleLogout}
//               className="flex items-center justify-center p-2 rounded-lg bg-red-950/30 text-red-500 hover:bg-red-500 hover:text-white transition-all border border-red-500/20"
//             >
